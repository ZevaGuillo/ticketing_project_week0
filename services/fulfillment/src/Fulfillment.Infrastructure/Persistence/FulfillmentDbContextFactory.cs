...
/// <summary>
/// Factory para crear instancias de FulfillmentDbContext en tiempo de diseño (migraciones).
...
public class FulfillmentDbContextFactory : IDesignTimeDbContextFactory<FulfillmentDbContext>
{
    public FulfillmentDbContext CreateDbContext(string[] args)
    {
        ...
        var schema = Environment.GetEnvironmentVariable("DB_SCHEMA") ?? "bc_fulfillment";
